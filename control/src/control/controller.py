...
class BaseController(object):
    ...
    def get_reference_index(self, pose, path_xytv, distance_lookahead):
        ...
        with self.path_condition:
            ...
            future_distances = distances[closest_index:]
            valid_indices = np.where(future_distances > distance_lookahead)[0]
            if len(valid_indices) > 0:
                return closest_index + valid_indices[0]
            # END QUESTION 1.1
